...
impl<'de> Deserialize<'de> for RSASignature {
    ...
    fn deserialize<D: Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        match deserializer.is_human_readable() {
            ...
            false => FromBytesDeserializer::<Self>::deserialize_with_size_encoding(deserializer, "rsa_signature"),
        }
    }
}
...
mod tests {
    ...
    fn test_serde_json() -> Result<()> {
        ...
        for i in 0..ITERATIONS {
            ...
            // Deserialize
            assert_eq!(expected, RSASignature::from_str(expected_string)?);
    ...
    fn test_bincode() -> Result<()> {
        ...
        for i in 0..ITERATIONS {
            ...
            // Deserialize
            assert_eq!(expected, RSASignature::read_le(&expected_bytes[..])?);
