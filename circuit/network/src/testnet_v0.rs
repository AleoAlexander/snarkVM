...
thread_local! {
    ...
    static SHA2_224: Sha2_224<AleoTestnetV0> = Sha2_224::<AleoTestnetV0>::new();
    /// The SHA-256 hash function, which outputs 256 bits.
    static SHA2_256: Sha2_256<AleoTestnetV0> = Sha2_256::<AleoTestnetV0>::new();
    /// The SHA-512 hash function, which outputs 384 bits.
    static SHA2_384: Sha2_384<AleoTestnetV0> = Sha2_384::<AleoTestnetV0>::new();
    /// The SHA-512 hash function, which outputs 512 bits.
    static SHA2_512: Sha2_512<AleoTestnetV0> = Sha2_512::<AleoTestnetV0>::new();
    /// The SHA-512 hash function, which outputs 224 bits.
    static SHA2_512_224: Sha2_512_224<AleoTestnetV0> = Sha2_512_224::<AleoTestnetV0>::new();
    /// The SHA-512 hash function, which outputs 256 bits.
    static SHA2_512_256: Sha2_512_256<AleoTestnetV0> = Sha2_512_256::<AleoTestnetV0>::new();
}
